...
namespace PBL3.Model
{
    public partial class PBL3Context : DbContext
    {
        ...
        public virtual DbSet<ThongKeTheoThoiGian> ThongKeTheoThoiGians { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ThongKeTheoThoiGian>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ThongKeTheoThoiGian");
